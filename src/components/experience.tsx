...
export default function Experience() {
  return (
    ...
    >
      <div className="flex px-24 mt-24 gap-y-8 pb-12">
        <div className="flex flex-col">
          <div className="relative flex flex-row items-center w-fit">
            <h3 className="text-4xl font-bold tracking-wider">Recent Work.</h3>
      ...
      <div className="h-[240px] bg-zinc-900">
        
      </div>

      <Link className="absolute bottom-2 left-[50%] text-zinc-50" href="#contact">
        <BsCaretDownFill />
      </Link>
